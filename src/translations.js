  ...
  'zh-TW': {
    ...
    types: {
      SECURE: {
        name: "安全型依戀 (Secure)",
        shortName: "安全型",
        desc: "你在親密關係中感到舒適和自信。你不擔心被拋棄，也樂於依賴他人或被他人依賴。你能夠有效地溝通需求，在衝突中保持情緒穩定。",
        detailedInfo: "安全型依戀者通常擁有溫暖、充滿回應的童年經歷。成年後，他們擁有高自尊，也信任他人。他們不玩心理遊戲，能夠直接表達愛意和需求。他們既享受親密，也能享受獨處。",
        idealMatch: "安全型固然是「百搭」的理想伴侶，能帶來穩定關係。但安全型之間也可能因為過於平淡而缺乏激情。關鍵在於雙方是否願意溝通和共同成長。",
        badMatch: "雖然你能和任何人相處，但嚴重未覺察、不願改變的非安全型伴侶，可能會給你帶來巨大的情感消耗，讓你懷疑自己。",
        growth: [
            "繼續保持你的開放和誠實，但也要保護好自己的能量。",
      ...
      ANXIOUS: {
        name: "焦慮型依戀 (Anxious)",
        shortName: "焦慮型",
        desc: "你渴望高度的親密感，但常擔心伴侶不愛你或會離開你。你對他人的情緒變化非常敏感，容易在關係中感到不安和情緒化。",
        detailedInfo: "焦慮型依戀者通常因為照顧者反應不一致而形成。成年後，他們傾向於通過「抗議行為」（如發脾氣、冷戰）來獲取關注。他們的自我價值感往往過度依賴伴侶的認可。",
        idealMatch: "安全型依戀者能給你最好的安撫。但其實，如果對方是願意溝通、能夠理解你不安的「自我覺察型」焦慮者，你們也能因為深刻的共情而建立緊密的連結。關鍵是避免「追逃模式」。",
        badMatch: "完全迴避溝通、冷暴力的伴侶（通常是未覺察的迴避型）。你追得越緊，他們跑得越遠，這會讓你陷入痛苦的循環。",
        growth: [
            "建立自我價值感：列出你的優點，不依賴外界確認。",
      ...
      DISMISSIVE: {
        ...
        shortName: "疏離型",
        desc: "你強調獨立和自給自足，往往將親密關係視為對自由的威脅。你會壓抑自己的情感需求，在伴侶試圖靠近時會下意識地後退。",
        detailedInfo: "疏離-迴避型依戀者可能因為童年時期情感需求被忽視，學會了「靠自己」。他們通常壓抑情緒，顯得冷漠或理性。他們實際上也有親密需求，但防禦機制讓他們否認這一點。",
        idealMatch: "安全型依戀者能尊重你的空間，讓你慢慢卸下防備。此外，另一個獨立的疏離型伴侶，只要雙方達成共識，也能建立一種「相敬如賓」的穩定關係，雖然可能情感濃度不高，但彼此都感到自在。",
        badMatch: "過度依賴、情緒化嚴重且不願獨立的伴侶（通常是嚴重的焦慮型）。他們的黏人會讓你感到窒息，觸發你的逃跑本能。",
        growth: [
      ...
      FEARFUL: {
        ...
        shortName: "恐懼型",
        desc: "你處於矛盾之中：既渴望親密，又極度恐懼受傷。你可能表現出「忽冷忽熱」的特質，想靠近卻又在靠近時感到恐慌。",
        detailedInfo: "恐懼型依戀者（也稱混亂型）通常經歷過創傷或極不穩定的照顧。他們想愛卻不敢愛。在關係中，他們可能在極其黏人和極其冷漠之間搖擺。",
        idealMatch: "安全型依戀者是療癒的最佳助攻，因為他們極其穩定。但如果有伴侶（無論何種類型）願意展現極大的耐心，並接受心理諮詢的輔助，關係依然可以很美好。這並非絕路，而是成長的起點。",
        badMatch: "情緒極不穩定、忽冷忽熱的伴侶。這種不確定性會加劇你的內在混亂，讓關係充滿戲劇性和痛苦。",
        growth: [
  ...
  'en': {
    ...
    types: {
      SECURE: {
        ...
        shortName: "Secure",
        desc: "You feel comfortable and confident in intimacy. You don't fear abandonment and are happy to depend on others.",
        detailedInfo: "Secure individuals usually had responsive caregivers. As adults, they have high self-esteem and trust others. They don't play mind games and communicate needs directly.",
        ...
        badMatch: "Severe, unaware insecure types who are unwilling to change may drain you emotionally.",
        growth: [
            "Maintain your openness and honesty but protect your energy.",
            "Be a 'secure base' for partners, but don't become their savior.",
            "Set boundaries; don't sacrifice your needs just to accommodate others."
        ]
      },
      ANXIOUS: {
        name: "Anxious/Preoccupied",
        shortName: "Anxious",
        desc: "You crave intimacy but fear abandonment. You are sensitive to partners' moods and can become emotional.",
        ...
        idealMatch: "Secure partners offer the best reassurance. However, a self-aware anxious partner who communicates well can also form a deep, empathetic bond with you.",
      ...
      DISMISSIVE: {
        ...
        desc: "You value independence and see intimacy as a threat to freedom. You suppress emotional needs.",
      ...
      FEARFUL: {
        ...
        shortName: "Fearful",
        desc: "You crave intimacy but fear getting hurt. You may oscillate between being clingy and distant.",
        detailedInfo: "Also known as Disorganized. Often stems from trauma. You want love but are terrified of it, leading to hot-and-cold behavior.",
  ...
  'ja': {
    ...
    types: {
      SECURE: {
        ...
        detailedInfo: "安定型は通常、温かく応答的な幼少期を過ごしています。自尊心が高く、他者を信頼できます。駆け引きをせず、愛情やニーズを率直に伝えます。",
        idealMatch: "安定型は誰にとっても理想的なパートナーであり、安定をもたらします。ただし、安定型同士は刺激に欠けると感じることもあるため、関係を深める努力は必要です。",
        badMatch: "変わる気のない、重度の不安定な愛着スタイルを持つパートナーは、あなたの感情を消耗させる可能性があります。",
        growth: [
      ...
      ANXIOUS: {
        ...
        detailedInfo: "養育者の一貫性のない対応によって形成されることが多いです。大人の場合、気を引くために「抗議行動」（癇癪や無視など）をとることがあります。",
      ...
      DISMISSIVE: {
        ...
        shortName: "回避型",
        desc: "自立を重視し、親密さを自由への脅威と見なします。感情的なニーズを抑圧し、相手が近づくと距離を置きます。",
        detailedInfo: "幼少期に感情的ニーズを無視され、「自分しか頼れない」と学んだ結果であることが多いです。冷淡に見えますが、実際には親密さへの欲求を持っています。",
        idealMatch: "あなたのスペースを尊重してくれる安定型。また、互いに合意があれば、別の自立した回避型とも「程よい距離感」の安定した関係を築けます。",
        badMatch: "過度に依存し、感情的なパートナー（重度の不安型）。彼らの要求はあなたを窒息させ、逃走本能を刺激します。",
        growth: [
      ...
      FEARFUL: {
        ...
        shortName: "恐れ型",
        desc: "親密さを求めながらも、傷つくことを極端に恐れる矛盾の中にいます。近づきたいのに近づくとパニックになることがあります。",
        detailedInfo: "未解決のトラウマや不安定な養育環境に由来することが多いです。愛したいのに愛するのが怖い状態です。極端な依存と拒絶の間で揺れ動くことがあります。",
        idealMatch: "非常に安定している安定型が癒やしに最適です。しかし、忍耐強く、心理的なサポートを受け入れるパートナーであれば、誰とでも良い関係を築ける可能性はあります。",
        badMatch: "情緒不安定で、態度がコロコロ変わるパートナー。不確実性があなたの混乱を悪化させます。",
        growth: [
  ...
  'es': {
    ...
    types: {
      SECURE: {
        ...
        shortName: "Seguro",
        desc: "Te sientes cómodo y seguro en la intimidad. No temes el abandono y te agrada depender de otros.",
        detailedInfo: "Las personas seguras suelen haber tenido cuidadores receptivos. Como adultos, tienen alta autoestima y confían en los demás. No juegan juegos mentales y comunican sus necesidades directamente.",
        ...
        badMatch: "Tipos inseguros graves y no conscientes que no están dispuestos a cambiar pueden agotarte emocionalmente.",
        growth: [
      ...
      ANXIOUS: {
        ...
        shortName: "Ansioso",
        desc: "Deseas intimidad pero temes el abandono. Eres sensible a los estados de ánimo de tu pareja y puedes volverte emocional.",
        ...
        idealMatch: "Las parejas seguras ofrecen la mejor tranquilidad. Sin embargo, una pareja ansiosa autoconsciente que se comunique bien también puede formar un vínculo profundo y empático contigo.",
      ...
      DISMISSIVE: {
        ...
        shortName: "Evitativo",
        desc: "Valoras la independencia y ves la intimidad como una amenaza a la libertad. Reprimes tus necesidades emocionales.",
        ...
        idealMatch: "Parejas seguras que respeten tu espacio. Otra pareja evitativa independiente también puede funcionar si ambos acuerdan una dinámica estable y de baja intensidad.",
      ...
      FEARFUL: {
        ...
        shortName: "Temeroso",
        desc: "Deseas intimidad pero temes salir herido. Puedes oscilar entre ser pegajoso y distante.",
        detailedInfo: "También conocido como Desorganizado. A menudo surge de traumas. Quieres amor pero te aterra, lo que lleva a un comportamiento de frío y calor.",
  ...
  'ko': {
    ...
    types: {
      SECURE: {
        name: "안정형 애착 (Secure)",
        shortName: "안정형",
        desc: "친밀한 관계에서 편안함과 자신감을 느낍니다. 버림받을 것을 걱정하지 않으며, 타인에게 의지하는 것을 편안하게 여깁니다.",
        detailedInfo: "안정형은 보통 반응이 좋은 양육자와 함께 자랐습니다. 성인이 되어서도 자존감이 높고 타인을 신뢰합니다. 밀당을 하지 않고 자신의 필요를 직접적으로 표현합니다.",
      ...
      ANXIOUS: {
        ...
        idealMatch: "안정형 파트너가 최고의 안심을 줍니다. 하지만 소통이 잘 되고 자기 인식이 있는 불안형 파트너와도 깊은 공감대를 형성할 수 있습니다.",
